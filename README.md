# Digital Mycelium Public Showcase
...
`DIGITAL_MYCELIUM_DEMO_READY_STATE_v0_3_HELD`

`BRIDGE_EXPORT_v0_1_PUBLIC_ROUTE_HELD`

`BRIDGE_EXPORT_CLICK_TEST_RECEIPT_v0_1_PUBLIC_ROUTE_HELD`
...
## For Builders: Carry Your Artifact Forward
...
- [Bridge Export v0.1](./BRIDGE_EXPORT_v0_1/)
- [Bridge Export Schema](./BRIDGE_EXPORT_v0_1/BRIDGE_EXPORT_SCHEMA_v0_1.md)
- [Example Bridge JSON](./BRIDGE_EXPORT_v0_1/dm_bridge_export.example.json)
- [Validation Battery](./BRIDGE_EXPORT_v0_1/VALIDATION_BATTERY_v0_1.md)
- [Click-Test Receipt](./BRIDGE_EXPORT_v0_1/BRIDGE_EXPORT_CLICK_TEST_RECEIPT_v0_1.md)
...
## What Digital Mycelium v0.3 Demonstrates
...
## What Bridge Export v0.1 Demonstrates
...
## Cross-Cognition and Collaboration
...
2. [DEMO_READY_STATE.md](DEMO_READY_STATE.md)
...
- [Main Public Route Click-Test](CLICK_TEST_HELD.md)
- [Bridge Export v0.1 Click-Test Receipt](./BRIDGE_EXPORT_v0_1/BRIDGE_EXPORT_CLICK_TEST_RECEIPT_v0_1.md)

---

## Active Public Routes

### Digital Mycelium v0.3
...
- [BRIDGE_EXPORT_v0_1/](./BRIDGE_EXPORT_v0_1/)

---

## Parked / Future Layers

### Audible, Music, Artistic, and Language Lineage
